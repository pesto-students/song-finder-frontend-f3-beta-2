...
function TermsCondition() {
    ...
    return (
        <div className={classes.root}>
            ...
            <p>Welcome to Immersis!</p>

            <p>
                These terms and conditions outline the rules and regulations for
                the use of Immersis&apos;s Website, located at
                https://immersis.netlify.app/.
            </p>

            <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Immersis if you do not agree
            ...
            <p>
                ...
                &lsquo;Client&rsquo;, &lsquo;You&rsquo; and &lsquo;Your&rsquo;
                refers to you, the person log on this website and compliant to
                the Company&apos;s terms and conditions. &lsquo;The
                Company&rsquo;, &lsquo;Ourselves&rsquo;, &lsquo;We&rsquo;,
                &lsquo;Our&rsquo; and &lsquo;Us&rsquo;, refers to our Company.
                &lsquo;Party&rsquo;, &lsquo;Parties&rsquo;, or &lsquo;Us&rsquo;,
            ...
            <p>
                We employ the use of cookies. By accessing Immersis, you agreed
                to use cookies in agreement with the Immersis&apos;s Privacy
                Policy.{' '}
            </p>
            ...
            <p>
                Unless otherwise stated, Immersis and/or its licensors own the
                intellectual property rights for all material on Immersis. All
                intellectual property rights are reserved. You may access this
                from Immersis for your own personal use subjected to
                restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from Immersis</li>
                <li>Sell, rent or sub-license material from Immersis</li>
                <li>Reproduce, duplicate or copy material from Immersis</li>
                <li>Redistribute content from Immersis</li>
            </ul>
            ...
            <p>
                ...
                website. Immersis does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Immersis,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Immersis shall not be liable for
            ...
            <p>
                Immersis reserves the right to monitor all Comments and to
            ...
            <p>
                You hereby grant Immersis a non-exclusive license to use,
            ...
            <p>
                ...
                of Immersis; and (d) the link is in the context of general
            ...
            <p>
                ...
                by sending an e-mail to Immersis. Please include your name, your
            ...
            <p>
                No use of Immersis&apos;s logo or other artwork will be allowed
